...
#' @param measuring_itnerval: measuring interval the observations are stretched to
...
#' @return placeholder
#' @export
stretch_sample_wrap <- function(cl, list_path, measuring_interval,
  ...
  sample_flagged_par <- clusterApplyLB(
    ...
    fun = function(smpl) {
      stretch_sample_helper(
        list_path = list_path, measuring_interval = measuring_interval,
...
#'
#' @param list_path: path to the random access list of the data set (generated by package largeList)
#' @param measuring_interval: Measuring interval currently under consideration
...
#'
#' @return placeholder
stretch_sample_helper <- function(list_path, measuring_interval,
  ...
  sample_dat_stretched <- stretch_data(
    func_dat = sample_dat, measuring_interval = measuring_interval
  )
